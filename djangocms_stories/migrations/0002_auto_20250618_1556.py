...
def insert_mapping_bkup(old_model, old_object_id, new_model, new_object_id):
    with connection.cursor() as cur:
        sql = """
            INSERT INTO model_id_map_blog_to_stories (old_model, old_object_id, new_model, new_object_id)
            VALUES (%s, %s, %s, %s)
        """
        params = [old_model, old_object_id, new_model, new_object_id]
...
def copy_data(pk_maps: dict, pass_2: list, source_model: models.Model, target_model: models.Model):
    ...
    for obj in source_objects:
        ...
        # Store the relation between old ids and new ids
        insert_mapping_bkup(source_model._meta.db_table, old_pk, target_model._meta.db_table, new_obj.pk)
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql="""
                CREATE TABLE model_id_map_blog_to_stories (
                    id BIGSERIAL PRIMARY KEY,
                    old_model VARCHAR(100) NOT NULL,
                    old_object_id BIGINT NOT NULL,
